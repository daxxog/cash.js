...
console.log('Cash.parse("$12.04");');
console.log(Cash.parse("$12.04").toNumber());
...
console.log('Cash.parseMode({strict: true});');
Cash.parseMode({strict: true});
...
console.log("Cash.parse('75.25').sub(Cash.parse('0.5')).toNumber()");
console.log(Cash.parse('75.25').sub(Cash.parse('0.5')).toNumber());

console.log("Cash.parse('75.25').sub(Cash.parse('0.5')).toNumber()");
console.log(Cash.parse('75.25').sub(Cash.parse('0.5')).add(Cash.parse('0.50')).toNumber());
